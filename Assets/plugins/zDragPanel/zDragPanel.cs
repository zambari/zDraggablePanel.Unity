...
namespace Z.DragRect
{
    ...
    public class zDragPanel : MonoBehaviour
    {
        ...
        public class PanelSetup
        {
            ...
            public Vector2 currentSize = new Vector2(100, 70);
        ...
        public PanelSetup panelSetup = new PanelSetup();
        public HoverColors _colors;
        public HoverColors colors { get { if (_colors == null) _colors = new HoverColors(); return _colors; } }
        RectTransform _rect;
        ...
        {
            if (panelSetup == null || panelSetup.frame == null)
        ...
        void SetSize()
        {
            ...
            rect.sizeDelta = panelSetup.currentSize;
        }
        ...
        void OnValidate()
        {
            if (id == 0) id = Random.Range(0, System.Int32.MaxValue);
        ...
        void SetSizeXY(float sizex, float sizey)
        {
            ...
            panelSetup.currentSize=new Vector2(sizex,sizey);
        }
        ...
        {
            return new PanelData() { size = rect.sizeDelta, position = rect.localPosition, id = id };
        }
